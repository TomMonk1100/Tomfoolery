...
export const UPGRADES: UpgradeDef[] = [
  ...
  { id: 'star_forge',      rarity: 'legendary', name: 'Star Forge',       icon: '🌠', pro: 'rarity weights ×3 toward rare+ in all future offers (compounds)', con: 'max fuel −10', desc: "Rare and better cards show up far more often from now on. Slightly smaller tank.", },
